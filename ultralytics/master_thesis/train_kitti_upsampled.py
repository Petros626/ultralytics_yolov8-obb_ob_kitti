...
# train configuration
dataset_cfg = '/home/heizung1/ultralytics_yolov8-obb_ob_kitti/ultralytics/cfg/datasets/kitti_bev_upsampled.yaml'
...
results = model.train(data=dataset_cfg, epochs=50, time=None, patience=0, batch=6, imgsz=1024, save=True, save_period=25, cache=True,
                      device=[0, 1], workers=8, project='mt_kitti_bev', name='upsampled', exist_ok=False, 
