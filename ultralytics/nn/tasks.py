...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, reg_max=None, verbose=True):  # model, input channels, number of classes
        ...
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=ch, reg_max=reg_max, verbose=verbose)  # model, savelist
...
class OBBModel(DetectionModel):
    ...
    def __init__(self, cfg="yolov8n-obb.yaml", ch=3, nc=None, reg_max=None, verbose=True):
...
def yaml_model_load(path):
    ...
    print(f'loaded yaml from:', yaml_file)
