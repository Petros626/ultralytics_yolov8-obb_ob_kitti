...
!!! example "MNN"
    ...
    === "Python"
        ...
        def inference(model, img, precision, backend, thread):
            ...
            image = image[..., ::-1] # BGR to RGB Fix MNN example missing BGR to RGB conversion, PR #18689
    ...
    === "CPP"
        ...
        int main(int argc, const char* argv[]) {
            ...
            image = cvtColor(image, COLOR_BGR2RGB); // BGR to RGB Fix MNN example missing BGR to RGB conversion, PR #18689
